...
{
	(void)me;
	me->reg._06h_Configuration_0.val.P0_0 = false;	// MF: P0_0 set ad Output
	me->reg._06h_Configuration_0.val.P0_1 = false;	// MF: P0_1 set ad Output
	me->reg._06h_Configuration_0.val.P0_2 = true;	// MF: P0_2 set ad Input
}
#endif
