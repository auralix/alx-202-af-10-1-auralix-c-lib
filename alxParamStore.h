...
// Preprocessor
//******************************************************************************
#define ALX_PARAM_STORE_MODULE "AlxParamStore.h"

// Assert //
#if defined(ALX_PARAM_STORE_ASSERT_BKPT_ENABLE)
	#define ALX_PARAM_STORE_ASSERT(expr) ALX_ASSERT_BKPT(ALX_PARAM_STORE_MODULE, expr)
#elif defined(ALX_PARAM_STORE_ASSERT_TRACE_ENABLE)
	#define ALX_PARAM_STORE_ASSERT(expr) ALX_ASSERT_TRACE(ALX_PARAM_STORE_MODULE, expr)
#elif defined(ALX_PARAM_STORE_ASSERT_RST_ENABLE)
	#define ALX_PARAM_STORE_ASSERT(expr) ALX_ASSERT_RST(ALX_PARAM_STORE_MODULE, expr)
#else
	#define ALX_PARAM_STORE_ASSERT(expr) do{} while (false)
#endif

// Trace //
#if defined(ALX_PARAM_STORE_TRACE_ENABLE)
	#define ALX_PARAM_STORE_TRACE(...) ALX_TRACE_WRN(ALX_PARAM_STORE_MODULE, __VA_ARGS__)
#else
