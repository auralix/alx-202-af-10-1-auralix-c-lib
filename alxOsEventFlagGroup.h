...
// Trace //
	...
	#define ALX_OS_EVENT_FLAG_GROUP_TRACE_WRN(...) ALX_TRACE_WRN(ALX_OS_EVENT_FLAG_GROUP_FILE, __VA_ARGS__)
#else
	#define ALX_OS_EVENT_FLAG_GROUP_TRACE_WRN(...) do{} while (false)
#endif
