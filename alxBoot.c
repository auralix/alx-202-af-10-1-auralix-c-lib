...
void AlxBoot_App_Usb_Update(AlxBoot* me)
{
	...
	// Trace
	ALX_BOOT_TRACE_INF("");
	ALX_BOOT_TRACE_INF("AlxBoot_App - USB FW Update Staging DONE");
	AlxBoot_App_StatusChange_Callback(me, AlxBoot_App_Status_FwUpStagingDone);
