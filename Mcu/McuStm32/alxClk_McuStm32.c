...
static void AlxClk_Ctor_McuStm32F4_Sysclk_168MHz_Pclk1Apb1_42MHz_Pclk2Apb2_84MHz_Hse_12MHz(AlxClk* me);
...
static void AlxClk_Ctor_McuStm32F7_Sysclk_216MHz_Pclk1Apb1_54MHz_Pclk2Apb2_108MHz_Hse_12MHz(AlxClk* me);
...
)
{
	...
	else if	(me->config == AlxClk_Config_McuStm32F4_Sysclk_168MHz_Pclk1Apb1_42MHz_Pclk2Apb2_84MHz_Hse_12MHz)					{ AlxClk_Ctor_McuStm32F4_Sysclk_168MHz_Pclk1Apb1_42MHz_Pclk2Apb2_84MHz_Hse_12MHz(me);			me->backupHsiEnable = false;	}
	...
	else if	(me->config == AlxClk_Config_McuStm32F7_Sysclk_216MHz_Pclk1Apb1_54MHz_Pclk2Apb2_108MHz_Hse_12MHz)					{ AlxClk_Ctor_McuStm32F7_Sysclk_216MHz_Pclk1Apb1_54MHz_Pclk2Apb2_108MHz_Hse_12MHz(me);			me->backupHsiEnable = false;	}
...
static void AlxClk_Ctor_McuStm32F4_Sysclk_168MHz_Pclk1Apb1_42MHz_Pclk2Apb2_84MHz_Hse_12MHz(AlxClk* me)
{
	...
	// Set expected clocks
	me->systemCoreClock_Ctor = 168000000;
	me->sysclk_Ctor = 168000000;
	me->hclk_Ctor = 168000000;
	me->pclk1Apb1_Ctor = 42000000;
	me->pclk2Apb2_Ctor = 84000000;
	me->pclk1Apb1Tim_Ctor = 42000000 * 2;
	me->pclk2Apb2Tim_Ctor = 84000000 * 2;
...
static void AlxClk_Ctor_McuStm32F7_Sysclk_216MHz_Pclk1Apb1_54MHz_Pclk2Apb2_108MHz_Hsi_16MHz(AlxClk* me)
{
	...
	me->pclk1Apb1Tim_Ctor = 54000000 * 4;
...
static void AlxClk_Ctor_McuStm32F7_Sysclk_216MHz_Pclk1Apb1_54MHz_Pclk2Apb2_108MHz_Hse_12MHz(AlxClk* me)
{
	...
	me->iosc.PLL.PLLState = RCC_PLL_ON;
	me->iosc.PLL.PLLSource = RCC_PLLSOURCE_HSE;
	me->iosc.PLL.PLLM = 6;	// VCO frequency = 1MHz, it must be between 1MHz and 2MHz, recommended is 2MHz to limit PLL jitter
	me->iosc.PLL.PLLN = 216;
	me->iosc.PLL.PLLP = RCC_PLLP_DIV2;
	me->iosc.PLL.PLLQ = 9;	// PLLQ frequency = 48MHz, it clocks USB_OTG_FS, SDMMC, RNG - USB_OTG_FS needs exactly 48MHz to work, SDMMC and RNG need 48MHz or lower
	#if defined (STM32F765xx) || defined (STM32F767xx) || defined (STM32F769xx) || defined (STM32F777xx) || defined (STM32F779xx)
