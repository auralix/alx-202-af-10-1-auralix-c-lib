...
// Trace //
	...
	#define ALX_MMC_TRACE(...) ALX_TRACE_WRN(ALX_MMC_FILE, __VA_ARGS__)
	#define ALX_MMC_TRACE_FORMAT(...) ALX_TRACE_FORMAT(__VA_ARGS__)
#else
	#define ALX_MMC_TRACE(...) do{} while (false)
	#define ALX_MMC_TRACE_FORMAT(...) do{} while (false)
#endif
