...
// Trace //
	...
	#define ALX_I2C_TRACE_ERR(...) ALX_TRACE_ERR(ALX_I2C_FILE, __VA_ARGS__)
	#define ALX_I2C_TRACE_WRN(...) ALX_TRACE_WRN(ALX_I2C_FILE, __VA_ARGS__)
	#define ALX_I2C_TRACE_DBG(...) ALX_TRACE_DBG(ALX_I2C_FILE, __VA_ARGS__)
	#define ALX_I2C_TRACE_VRB(...) ALX_TRACE_VRB(ALX_I2C_FILE, __VA_ARGS__)
#else
	#define ALX_I2C_TRACE_FORMAT(...) do{} while (false)
	#define ALX_I2C_TRACE_ERR(...) do{} while (false)
	#define ALX_I2C_TRACE_WRN(...) do{} while (false)
	#define ALX_I2C_TRACE_DBG(...) do{} while (false)
