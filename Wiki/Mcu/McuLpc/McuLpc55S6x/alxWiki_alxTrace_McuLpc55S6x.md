...
- RTOS Thread Safety is implemented for this module
    - In order use it, "ALX_OS" has to be defined in "alxConfig.h"
- __USART_Init()__ function handles everything for FlexComm periphery
