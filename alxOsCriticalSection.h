...
// Trace //
	...
	#define ALX_OS_CRITICAL_SECTION_TRACE_WRN(...) ALX_TRACE_WRN(ALX_OS_CRITICAL_SECTION_FILE, __VA_ARGS__)
#else
	#define ALX_OS_CRITICAL_SECTION_TRACE_WRN(...) do{} while (false)
#endif
