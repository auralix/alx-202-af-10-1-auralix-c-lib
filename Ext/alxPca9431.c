...
Alx_Status AlxPca9431_Rect_GetVoltage_V(AlxPca9431* me, float* voltage_V)
{
	...
	// #4 Conversion
	AdcBitVoltage += AdcLBitVoltage;
	ALX_PCA9431_TRACE(&alxTrace, "Test Adc_AdcBitVoltage: %lu \r\n", AdcBitVoltage);
...
Alx_Status AlxPca9431_Reg_ReadAndClearInterrupt(AlxPca9431* me)
{
	...
	ALX_PCA9431_TRACE(&alxTrace, "Read 1 SistemIntVal: %lu \r\n", SistemIntVal);
	ALX_PCA9431_TRACE(&alxTrace, "Read 2 SistemIntVal: %lu \r\n", SistemIntVal2);
	...
	ALX_PCA9431_TRACE(&alxTrace, "Read 1 VRectmIntVal: %lu \r\n", VRectmIntVal);
	ALX_PCA9431_TRACE(&alxTrace, "Read 2 VRectmIntVal: %lu \r\n", VRectmIntVal2);
	...
	ALX_PCA9431_TRACE(&alxTrace, "Read 1 VOutLdoIntVal: %lu \r\n", VOutLdoIntVal);
	ALX_PCA9431_TRACE(&alxTrace, "Read 2 VOutLdoIntVal: %lu \r\n", VOutLdoIntVal2);
...
static Alx_Status AlxPca9431_TraceId(AlxPca9431* me)
{
	...
	// #2 Trace
	ALX_PCA9431_TRACE("\r\n");
	ALX_PCA9431_TRACE("Auralix C Library ALX wireless charging receiver PCA9431 Module Identification:\r\n");
	ALX_PCA9431_TRACE("- REVID: 0x%03X\r\n", me->reg._00h_Device_ID.val.Revision);
	ALX_PCA9431_TRACE("- DEVID: 0x%04X\r\n", me->reg._00h_Device_ID.val.ID);
	ALX_PCA9431_TRACE("- UNUSED: 0x%01X\r\n", me->reg._00h_Device_ID.val.unused_7);
	ALX_PCA9431_TRACE("\r\n");
	// #3 Return OK
	return Alx_Ok;
}
