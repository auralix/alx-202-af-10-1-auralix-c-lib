...
// Preprocessor
//******************************************************************************
#define ALX_TMP1075_MODULE "AlxTmp1075.h"

// Assert //
#if defined(ALX_TMP1075_ASSERT_BKPT_ENABLE)
	#define ALX_TMP1075_ASSERT(expr) ALX_ASSERT_BKPT(ALX_TMP1075_MODULE, expr)
#elif defined(ALX_TMP1075_ASSERT_TRACE_ENABLE)
	#define ALX_TMP1075_ASSERT(expr) ALX_ASSERT_TRACE(ALX_TMP1075_MODULE, expr)
#elif defined(ALX_TMP1075_ASSERT_RST_ENABLE)
	#define ALX_TMP1075_ASSERT(expr) ALX_ASSERT_RST(ALX_TMP1075_MODULE, expr)
#else
...
// Trace //
	...
	#define ALX_TMP1075_TRACE_WRN(...) ALX_TRACE_WRN(ALX_TMP1075_MODULE, __VA_ARGS__)
	#define ALX_TMP1075_TRACE_INF(...) ALX_TRACE_INF(ALX_TMP1075_MODULE, __VA_ARGS__)
#else
