...
//static Alx_Status AlxAdau1961_WaitUntilPllLock(AlxAdau1961* me);

//Alx_Status AlxAdau1961_StartStream(AlxAdau1961* me)
//{
//	ALX_ADAU1961_ASSERT(false);
//	return Alx_Err;
//}
//Alx_Status AlxAdau1961_StopStream(AlxAdau1961* me)
//{
//	ALX_ADAU1961_ASSERT(false);
//	return Alx_Err;
//}
//Alx_status AlxAdau1961_Dac_SetGain_dB(AlxAdau1961* me, uint8_t* dacId, float* gain_dB)
//{
//	ALX_ADAU1961_ASSERT(me->isInit == true);
//	ALX_ADAU1961_ASSERT(me->wasCtorCalled == true);
//	ALX_ADAU1961_ASSERT((*dacId == AlxAdau1961_DacId_L) || (*dacId == AlxAdau1961_DacId_R));
//
//	return Alx_Err;
//}
//Alx_status AlxAdau1961_Dac_SetGain_pct(AlxAdau1961* me, uint8_t* dacId, float* gain_pct)
//{
//	ALX_ADAU1961_ASSERT(me->isInit == true);
//	ALX_ADAU1961_ASSERT(me->wasCtorCalled == true);
//	ALX_ADAU1961_ASSERT((*dacId == AlxAdau1961_DacId_L) || (*dacId == AlxAdau1961_DacId_R));
...
//	ALX_ADAU1961_ASSERT(me->wasCtorCalled == true);
//	ALX_ADAU1961_ASSERT((*dacId == AlxAdau1961_DacId_L) || (*dacId == AlxAdau1961_DacId_R));
//	ALX_ADAU1961_ASSERT((*volume_dB <= 0) && (*volume_dB >= -95.625));
//
//	if (*dacId == AlxAdau1961_DacId_L)
//	{
//		me->reg.R37_DacControl1.val.LDAVOL = (*volume_dB * -1) / 0.375;
//
//		if (AlxAdau1961_Reg_Write(me, &me->reg.R37_DacControl1) != Alx_Ok)		{ return Alx_Err; }
//	}
//	else if (*dacId == AlxAdau1961_DacId_R)
//	{
//		me->reg.R38_DacControl2.val.RDAVOL = (*volume_dB * -1) / 0.375;
//
//		if (AlxAdau1961_Reg_Write(me, &me->reg.R38_DacControl2) != Alx_Ok)		{ return Alx_Err; }
//	}
//
//	return Alx_Ok;
//}
//Alx_status AlxAdau1961_Dac_SetVolume_pct(AlxAdau1961* me, uint8_t* dacId, float* volume_pct)
//{
//	ALX_ADAU1961_ASSERT(me->isInit == true);
//	ALX_ADAU1961_ASSERT(me->wasCtorCalled == true);
//	ALX_ADAU1961_ASSERT((*dacId == AlxAdau1961_DacId_L) || (*dacId == AlxAdau1961_DacId_R));
...
//	if (*dacId == AlxAdau1961_DacId_L)
//	{
//		me->reg.R22_PlayMixerLeft0.val.MX3LM = 0;
//		me->reg.R24_PlayMixerRight0.val.MX4LM = 0;
//	}
//	else if (*dacId == AlxAdau1961_DacId_R)
//	{
//		me->reg.R22_PlayMixerLeft0.val.MX3RM = 0;
//		me->reg.R24_PlayMixerRight0.val.MX4RM = 0;
//	}
//
//	if (AlxAdau1961_Reg_Write(me, &me->reg.R22_PlayMixerLeft0) != Alx_Ok)		{ return Alx_Err; }
//	if (AlxAdau1961_Reg_Write(me, &me->reg.R24_PlayMixerRight0) != Alx_Ok)		{ return Alx_Err; }
//
//	return Alx_Ok;
//}
...
//	ALX_ADAU1961_ASSERT(me->isInit == true);
//	ALX_ADAU1961_ASSERT(me->wasCtorCalled == true);
//	ALX_ADAU1961_ASSERT(*chIn == AlxAdau1961_Ch_LIN || *chIn == AlxAdau1961_Ch_RIN);// || *chIn == AlxAdau1961_Ch_LAUX || *chIn == AlxAdau1961_Ch_RAUX);
//	ALX_ADAU1961_ASSERT(*chOut == AlxAdau1961_Ch_LOUT || *chOut == AlxAdau1961_Ch_ROUT);
//
//	Alx_Status status = Alx_Err;
//
//	if ((*chIn == AlxAdau1961_Ch_LIN) && (*chOut == AlxAdau1961_Ch_LOUT))
//	{
//		me->reg.R22_PlayMixerLeft0.val.MX3LM = 1;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R22_PlayMixerLeft0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R22_PlayMixerLeft0		"); return status;}
//	}
//	else if ((*chIn == AlxAdau1961_Ch_LIN) && (*chOut == AlxAdau1961_Ch_ROUT))
//	{
//		me->reg.R24_PlayMixerRight0.val.MX4LM = 1;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R24_PlayMixerRight0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R24_PlayMixerRight0		"); return status;}
//	}
//	else if ((*chIn == AlxAdau1961_Ch_RIN) && (*chOut == AlxAdau1961_Ch_LOUT))
//	{
//		me->reg.R22_PlayMixerLeft0.val.MX3RM = 1;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R22_PlayMixerLeft0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R22_PlayMixerLeft0		"); return status;}
//	}
//	else if ((*chIn == AlxAdau1961_Ch_RIN) && (*chOut == AlxAdau1961_Ch_ROUT))
//	{
//		me->reg.R24_PlayMixerRight0.val.MX4RM = 1;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R24_PlayMixerRight0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R24_PlayMixerRight0		"); return status;}
//	}
//	else { ALX_ADAU1961_ASSERT(false); }	// We shouldn't get here
//
//	return Alx_Ok;
//}
//Alx_Status AlxAdau1961_Ch_In_SetGain_pct(AlxAdau1961* me, AlxAdau1961_Ch* ch, float* gain_pct)
//{
//	ALX_ADAU1961_ASSERT(me->isInit == true);
//	ALX_ADAU1961_ASSERT(me->wasCtorCalled == true);
//	ALX_ADAU1961_ASSERT(*ch == AlxAdau1961_Ch_LIN || *ch == AlxAdau1961_Ch_RIN || *ch == AlxAdau1961_Ch_LAUX || *ch == AlxAdau1961_Ch_RAUX);
//
//	Alx_Status status = Alx_Err;
//	uint8_t dummy = 0;
//
//	if (*ch == AlxAdau1961_Ch_LIN)
//	{
//		dummy = AlxGlobal_Round((*gain_pct * 64) / 100);		// MF: 64 because LOUTVOL is 6bit number
//		me->reg.R8_LeftDiffInputVol.val.LDVOL = dummy;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R8_LeftDiffInputVol);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R8_LeftDiffInputVol		"); return status;}
//	}
//	else if (*ch == AlxAdau1961_Ch_RIN)
//	{
//		dummy = AlxGlobal_Round((*gain_pct * 64) / 100);		// MF: 64 because LOUTVOL is 6bit number
//		me->reg.R9_RightDiffInputVol.val.RDVOL = dummy;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R9_RightDiffInputVol);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R9_RightDiffInputVol		"); return status;}
//	}
//	else if (*ch == AlxAdau1961_Ch_LAUX)
//	{
//		dummy = AlxGlobal_Round((*gain_pct * 8) / 100);			// MF: 8 because LOUTVOL is 3bit number
//		me->reg.R5_RecMixerLeft1.val.MX1AUXG = dummy;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R5_RecMixerLeft1);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R5_RecMixerLeft1		"); return status;}
//	}
//	else if (*ch == AlxAdau1961_Ch_RAUX)
//	{
//		dummy = AlxGlobal_Round((*gain_pct * 8) / 100);			// MF: 8 because LOUTVOL is 3bit number
//		me->reg.R7_RecMixerRight1.val.MX2AUXG = dummy;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R7_RecMixerRight1);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R7_RecMixerRight1		"); return status;}
//	}
...
//	ALX_ADAU1961_ASSERT(me->isInit == true);
//	ALX_ADAU1961_ASSERT(me->wasCtorCalled == true);
//	ALX_ADAU1961_ASSERT(*ch == AlxAdau1961_Ch_LOUT || *ch == AlxAdau1961_Ch_ROUT);
//
//	Alx_Status status = Alx_Err;
//	uint8_t dummy = 0;
//
//	if (*ch == AlxAdau1961_Ch_LOUT)
//	{
//		dummy = AlxGlobal_Round((*volume_pct * 64) / 100);		// MF: 64 because LOUTVOL is 6bit number
//		me->reg.R31_LineOutputLeftVol.val.LOUTVOL = dummy;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R31_LineOutputLeftVol);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R31_LineOutputLeftVol	"); return status;}
//	}
//	else if (*ch == AlxAdau1961_Ch_ROUT)
//	{
//		dummy = AlxGlobal_Round((*volume_pct * 64) / 100);		// MF: 64 because LOUTVOL is 6bit number
//		me->reg.R32_LineOutputRightVol.val.ROUTVOL = dummy;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R32_LineOutputRightVol);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R32_LineOutputRightVol	"); return status;}
//	}
...
//	if (ch == AlxAdau1961_Ch_LIN)
//	{
//		me->reg.R4_RecMixerLeft0.val.LINNG = 0;
//		me->reg.R4_RecMixerLeft0.val.LINPG = 0;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R4_RecMixerLeft0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R4_RecMixerLeft0		"); return status;}
//	}
//	else if (ch == AlxAdau1961_Ch_RIN)
//	{
//		me->reg.R6_RecMixerRight0.val.RINNG = 0;
//		me->reg.R6_RecMixerRight0.val.RINPG = 0;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R6_RecMixerRight0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R6_RecMixerRight0		"); return status;}
//	}
//	else if (ch == AlxAdau1961_Ch_LAUX)
//	{
//		me->reg.R5_RecMixerLeft1.val.MX1AUXG = 0;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R5_RecMixerLeft1);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R5_RecMixerLeft1		"); return status;}
//	}
//	else if (ch == AlxAdau1961_Ch_RAUX)
//	{
//		me->reg.R7_RecMixerRight1.val.MX2AUXG = 0;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R7_RecMixerRight1);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R7_RecMixerRight1		"); return status;}
//	}
//	else if (ch == AlxAdau1961_Ch_LOUT)
//	{
//		me->reg.R22_PlayMixerLeft0.val.MX3LM = 0;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R22_PlayMixerLeft0);
...
//	if (ch == AlxAdau1961_Ch_LIN)
//	{
//		me->reg.R4_RecMixerLeft0.val.LINNG = 7;
//		me->reg.R4_RecMixerLeft0.val.LINPG = 7;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R4_RecMixerLeft0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R4_RecMixerLeft0		"); return status;}
//	}
//	else if (ch == AlxAdau1961_Ch_RIN)
//	{
//		me->reg.R6_RecMixerRight0.val.RINNG = 7;
//		me->reg.R6_RecMixerRight0.val.RINPG = 7;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R6_RecMixerRight0);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R6_RecMixerRight0		"); return status;}
//	}
//	else if (ch == AlxAdau1961_Ch_LAUX)
//	{
//		me->reg.R5_RecMixerLeft1.val.MX1AUXG = 7;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R5_RecMixerLeft1);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R5_RecMixerLeft1		"); return status;}
//	}
//	else if (ch == AlxAdau1961_Ch_RAUX)
//	{
//		me->reg.R7_RecMixerRight1.val.MX2AUXG = 7;
//
//		status = AlxAdau1961_Reg_Write(me, &me->reg.R7_RecMixerRight1);
//		if (status != Alx_Ok) { ALX_ADAU1961_TRACE("Err_R7_RecMixerRight1		"); return status;}
//	}
...
//	uint8_t dummy[6] = {0};
//	AlxTimSw timer;
//	AlxTimSw_Ctor(&timer, true);
//
//	// #2 Poll PLL Lock bit
//	do
//	{
//		AlxI2c_Master_StartReadMemStop(me->i2c, me->i2cAddr, *(uint16_t*)&me->reg.R1_PllControl, AlxI2c_Master_MemAddrLen_16bit, dummy, 6, me->i2cNumOfTries, me->i2cTimeout_ms);
//
//		if ((dummy[5] & (1 << 1)) == 2)			// Check if "lock Bit" (2nd bit) is set in 6th byte of R1_PllControl
//			return Alx_Ok;
//
//	} while (AlxTimSw_Get_ms(&timer) < 20);		// MF: 20ms timeout is hardcoded
//
//	return Alx_Err;
//}
