...
// Preprocessor
//******************************************************************************
#define ALX_NTCG103JF103FT1S_MODULE "AlxNtcg103jf103ft1s.h"

// Assert //
#if defined(ALX_NTCG103JF103FT1S_ASSERT_BKPT_ENABLE)
	#define ALX_NTCG103JF103FT1S_ASSERT(expr) ALX_ASSERT_BKPT(ALX_NTCG103JF103FT1S_MODULE, expr)
#elif defined(ALX_NTCG103JF103FT1S_ASSERT_TRACE_ENABLE)
	#define ALX_NTCG103JF103FT1S_ASSERT(expr) ALX_ASSERT_TRACE(ALX_NTCG103JF103FT1S_MODULE, expr)
#elif defined(ALX_NTCG103JF103FT1S_ASSERT_RST_ENABLE)
	#define ALX_NTCG103JF103FT1S_ASSERT(expr) ALX_ASSERT_RST(ALX_NTCG103JF103FT1S_MODULE, expr)
#else
...
// Trace //
	...
	#define ALX_NTCG103JF103FT1S_TRACE(...) ALX_TRACE_WRN(ALX_NTCG103JF103FT1S_MODULE, __VA_ARGS__)
#else
