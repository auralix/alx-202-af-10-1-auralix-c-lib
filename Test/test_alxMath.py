...
The file also covers alxGlobal's three number-formatting helpers, which are compiled into the same
group because they have no home of their own: a uint64 and an int64 to decimal text, and a byte
swap. The first is on the CLI path of any product that publishes a 64-bit value.

Test group P169-P200 = ALX-1553 signal conditioning and number formatting proofs.
"""
...
# =====================================================================
# P198-P200 - the number formatting in alxGlobal
# =====================================================================
